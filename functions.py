...
def display_metrics_expand(percent):
    if percent is None:
        ...
        percent_display = f"<span style='color:darkgreen; background-color:lightslategrey; font-weight:bold'>{percent}%</span>"
    elif percent >= 55:
        percent_display = f"<span style='color:lightgreen; background-color:lightslategrey; font-weight:bold'>{percent}%</span>"
    elif 52 <= percent < 55:
        percent_display = f"<span style='color:orange; background-color:lightslategrey; font-weight:bold'>{percent}%</span>"
    elif 48 < percent < 52:
        percent_display = f"<span style='color:#545353ff; font-weight:bold'>{percent}%</span>"
    elif 46 < percent <=48:
        percent_display = f"<span style='color:orange; background-color:lightslategrey; font-weight:bold'>{percent}%</span>"
    elif 40 <= percent <= 46:
        percent_display = f"<span style='color:orangered; background-color:lightslategrey; font-weight:bold'>{percent}%</span>"
    elif percent < 40:
        percent_display = f"<span style='color:red; background-color:lightslategrey; font-weight:bold'>{percent}%</span>"
    else:
