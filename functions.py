        ...
        <div style="border:2px solid #DAA520; border-radius:8px; padding:4px; background-color:#000000; margin-bottom:0px;">    
            ...
            <div style="display:flex; justify-content:space-around; margin-bottom:0px;">
                <div style="text-align:center;">
                    <h4 class="team-header" style="text-decoration:underline; margin:0;">{away_img}{safe_away_team} vs Trend</h4><br>
                </div>
                <div style="text-align:center;">
                    <h4 class="team-header" style="text-decoration:underline; margin:0;">{home_img}{safe_home_team} vs Trend</h4><br>
                </div>
            </div>
            <!-- Records -->
